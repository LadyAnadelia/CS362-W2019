...
int main() {
	...
	r = caseMine(&testG, choice1, choice2, handPos, currentPlayer);
	printf("Set a non-coin return = %d, expected = -1\n", r);
	//check choice2 is not out of range of choices	
	choice1 = copper;
	r1 = caseMine(&testG, choice1, choice2, handPos, currentPlayer);
	printf("Set bad value for choice2 return = %d, expected = -1\n", r1);

	choice2 = province;

	r2 = caseMine(&testG, choice1, choice2, handPos, currentPlayer);
	...
	r3 = caseMine(&testG, choice1, choice2, handPos, currentPlayer);
